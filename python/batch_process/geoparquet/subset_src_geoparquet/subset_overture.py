...
subset_output_path = "s3://carbonplan-share/vector_web/geoparquet/input/CA_overture_buildings.parquet"
...
bbox.ymin BETWEEN {bbox[1]} AND {bbox[3]} ) TO '{subset_output_path}'  (FORMAT 'parquet', COMPRESSION 'zstd', OVERWRITE_OR_IGNORE true);""")
